...
if ($method == "POST" && $_SESSION['username'] != "") {
    ...
    // Handles upload requests
        ...
        $result["timeStamp"] = $timeStamp->setStamp($result["uuid"],$result["uploadName"], $_GET['flowId'], $_SESSION['user_id'], $_GET['identifier']);
        $result["flowID"] = $_GET['flowId'];
        $result["userId"] = $_SESSION['username'];
    }

    echo json_encode($result);
}
// for delete file requests
else if ($method == "DELETE" && $_SESSION['username'] != "") {
