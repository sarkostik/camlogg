...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    .selectpicker('refresh');
     ...
     $.ajax({
            type: 'GET',
            url: '/framework/core/project/flow/user/list',                    
            cache: false,   
            dataType: 'JSON',     
  ...
  function updateProject(isCreateProject){
        ...
        <form class="form-horizontal" >
          ...
          <div class="form-group last">            
            <div class="col-sm-offset-3 col-sm-9">
              ...
              <input type="button" onclick="updateProject(false)" value="Avbryt" class="btn btn-default btn-sm">                
